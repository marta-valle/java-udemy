...
public class _1040 {
	...
	public static void main(String[] args) {
		/* Concluido( tive dificuldade na escolha do tipo de variavel. Usei double, porem a resposta não estava tão precisa)
		 * 
		...
		Recalcule a média (some a pontuação do exame com a média anteriormente calculada e divida por 2).
		 e imprima a mensagem "Aluno aprovado." (caso a média final seja 5.0 ou mais ) ou "Aluno reprovado.", (caso a média tenha ficado 4.9 ou menos). Para estes dois casos (aprovado ou reprovado após ter pego exame) apresente na última linha uma mensagem "Media final: " seguido da média final para esse aluno.
        ...
        media =(a*2f+ b*3f + c*4f + d*1f )/10f;  // Poderia declarar o média float aqui, como "float media = (n1 * 2f + n2 * 3f + n3 * 4f + n4 * 1f) / 10f;"
