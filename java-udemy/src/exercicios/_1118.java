	...
	public static void main(String[] args) {
		 ...
		 *  Cada nota deve ser validada separadamente.
			...
			No final deve ser impressa a mensagem “novo calculo (1-sim 2-nao)”,
			 solicitando ao usuário que informe um código (1 ou 2) indicando se ele deseja ou não executar o algoritmo novamente, (aceitar apenas os código 1 ou 2). Se for informado o código 1 deve ser repetida a execução de todo o programa para permitir um novo cálculo, caso contrário o programa deve ser encerrado.
        ...
        do {
            ...
            /* se colocar If, e digitar 2 x errado, o segundo numero é aceito, por isso precisa ser repetição*/
